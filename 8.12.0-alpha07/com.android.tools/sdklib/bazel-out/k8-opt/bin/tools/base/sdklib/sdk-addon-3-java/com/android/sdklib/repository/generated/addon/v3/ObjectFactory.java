    ...
    extends AddonFactory
{
    ...
    private final static QName _SdkAddon_QNAME = new QName("http://schemas.android.com/sdk/android/repo/addon2/03", "sdk-addon");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.android.sdklib.repository.generated.addon.v3
     * 
     */
