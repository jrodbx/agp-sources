...
/**
 * Implementation of AndroidLocations for AGP to be used via a Build Services that will
 * essentially make this a singleton valid only for the current build.
 *
 */
class AndroidLocations(
