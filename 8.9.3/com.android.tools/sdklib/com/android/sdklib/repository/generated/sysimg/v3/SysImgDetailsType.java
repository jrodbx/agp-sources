...
/**
 * DO NOT EDIT This file was generated by xjc from sdk-sys-img-03.xsd. Any changes will be lost upon
 * recompilation of the schema. See the schema file for instructions on running xjc.
 *
 *
 * type-details subclass including system image-specific information: - tag, specifying the device
 * type (tablet, tv, wear, etc.) - vendor, the vendor for this system image (android, google, etc.)
 ...
 *         &lt;element name="abi" type="{http://schemas.android.com/sdk/android/repo/sys-img2/03}abiType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SysImgDetailsType
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link IdDisplayType }
     */
