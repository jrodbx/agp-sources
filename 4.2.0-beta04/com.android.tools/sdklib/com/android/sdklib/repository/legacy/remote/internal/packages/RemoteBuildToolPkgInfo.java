...
public class RemoteBuildToolPkgInfo extends RemotePkgInfo {
    ...
    /**
     * Creates a new build-tool package from the attributes and elements of the given XML node. This
     ...
     */
    public RemoteBuildToolPkgInfo(SdkSource source, Node packageNode, String nsUri,
            Map<String, String> licenses) {
        super(source, packageNode, nsUri, licenses);
        PkgDesc.Builder pkgDescBuilder = PkgDesc.Builder.newBuildTool(getRevision());
        pkgDescBuilder.setDescriptionShort(
                createShortDescription(mListDisplay, getRevision(), isObsolete()));
    ...
    private static String createShortDescription(String listDisplay, Revision revision,
        ...
        return String.format("Android SDK Build-tools, revision %1$s%2$s", revision.toShortString(),
                obsolete ? " (Obsolete)" : "");
    }
}
