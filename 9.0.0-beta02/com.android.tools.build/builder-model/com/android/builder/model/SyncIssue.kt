...
interface SyncIssue {
    ...
    companion object {
        ...
        /**
         * Using an empty flavor dimension. An empty flavor dimension results in an error when
         * calculating the dimension combinations and no variants are created..
         */
         ...
         * or higher. Data is the Kotlin version used.
         */
