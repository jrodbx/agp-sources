 ...
 * generated in the com.android.repository.impl.generated.v2 package. 
    ...
    extends CommonFactory
{
    ...
    private final static QName _Repository_QNAME = new QName("http://schemas.android.com/repository/android/common/02", "repository");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.android.repository.impl.generated.v2
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://schemas.android.com/repository/android/common/02", name = "repository")
