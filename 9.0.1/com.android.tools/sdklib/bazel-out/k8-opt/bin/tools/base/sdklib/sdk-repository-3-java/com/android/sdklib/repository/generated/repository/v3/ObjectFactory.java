    ...
    extends RepoFactory
{
    ...
    private final static QName _SdkRepository_QNAME = new QName("http://schemas.android.com/sdk/android/repo/repository2/03", "sdk-repository");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.android.sdklib.repository.generated.repository.v3
     * 
     */
