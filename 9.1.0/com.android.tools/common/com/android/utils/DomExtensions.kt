...
/** Adds an iterable implementation on Element such that we can use it in a for loop to iterate over the children */
...
fun Node.childrenIterator(): Iterator<Node> =
...
/**
 * Visits all the attributes of the given element transitively. The [visitor] should return false, or true to abort visiting when it has
 * found what it was looking for. Returns true if any visited attribute returned true.
 */
...
/**
 * Visits all the elements of the given element transitively. The [visitor] should return false, or true to abort visiting when it has found
 * what it was looking for. Returns true if any visited element returned true.
 */
