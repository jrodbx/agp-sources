...
/**
 * These are messages issued when a specific bug manifests. The error code should be the bug number and bugNumber should not coincide with
 * any values in [CxxDiagnosticCode].
 */
