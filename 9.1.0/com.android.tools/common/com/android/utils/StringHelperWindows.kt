...
object StringHelperWindows {
  ...
  fun tokenizeCommandLineToEscaped(commandLine: String) =
    TokenizedCommandLine(commandLine, false, SdkConstants.PLATFORM_WINDOWS).toTokenList()

  @JvmStatic
  fun tokenizeCommandLineToRaw(commandLine: String) = TokenizedCommandLine(commandLine, true, SdkConstants.PLATFORM_WINDOWS).toTokenList()
}
