...
data class GenericBuiltArtifacts(
  ...
  /**
   * Identifies the [GenericBuiltArtifacts] for this [Collection] of [GenericBuiltArtifacts], all [GenericBuiltArtifact] are the same type
   * of artifact.
   *
  ...
  /**
   * Type of file stored in [elements], can be "File" or "Directory", or null if there are no elements or for outputs of older Android
   * Gradle plugins (version 4.1.0).
   */
