...
/**
 * A [FontDetail] is a reference to a specific font with weight, width, and italics attributes. Each instance refers to a possibly remote
 * (*.ttf) font file.
 */
class FontDetail {
  ...
  override fun equals(other: Any?): Boolean {
    return other is FontDetail && weight == other.weight && width == other.width && italics == other.italics
  }
