...
/**
 * A map that treats all the keys as resources names. This class takes care of the key flattening done by AAPT where '.', '-' and ':' are
 * all replaced with '_' and will be able to find resources with those characters in the name no matter the format. Because of that, for
 * keys like 'my.key', 'my_key' and 'my-key' are considered equivalent.
 */
