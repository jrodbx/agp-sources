...
private fun applyVersionForCompatibility(config: ConfigDescription): ConfigDescription {
  val minSdk =
    when {
      ...
      config.smallestScreenWidthDp != 0 || config.screenWidthDp != 0 || config.screenHeightDp != 0 -> SDKConstants.SDK_HONEYCOMB_MR2
      config.uiModeType() != ResTableConfig.UI_MODE.TYPE_ANY || config.uiModeNight() != ResTableConfig.UI_MODE.NIGHT_ANY ->
        SDKConstants.SDK_FROYO
