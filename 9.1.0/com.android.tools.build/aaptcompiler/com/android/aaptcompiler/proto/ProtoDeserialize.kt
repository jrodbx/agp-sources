...
fun deserializeConfigFromPb(config: ConfigurationOuterClass.Configuration, logger: ILogger?): ConfigDescription? {
  ...
  val screenLayoutDir =
    when (config.getLayoutDirection()) {
      ConfigurationOuterClass.Configuration.LayoutDirection.LAYOUT_DIRECTION_LTR -> ResTableConfig.SCREEN_LAYOUT.DIR_LTR
      ConfigurationOuterClass.Configuration.LayoutDirection.LAYOUT_DIRECTION_RTL -> ResTableConfig.SCREEN_LAYOUT.DIR_RTL
  ...
  val screenLayoutSize =
    when (config.getScreenLayoutSize()) {
      ConfigurationOuterClass.Configuration.ScreenLayoutSize.SCREEN_LAYOUT_SIZE_SMALL -> ResTableConfig.SCREEN_LAYOUT.SIZE_SMALL
      ConfigurationOuterClass.Configuration.ScreenLayoutSize.SCREEN_LAYOUT_SIZE_NORMAL -> ResTableConfig.SCREEN_LAYOUT.SIZE_NORMAL
      ConfigurationOuterClass.Configuration.ScreenLayoutSize.SCREEN_LAYOUT_SIZE_LARGE -> ResTableConfig.SCREEN_LAYOUT.SIZE_LARGE
      ConfigurationOuterClass.Configuration.ScreenLayoutSize.SCREEN_LAYOUT_SIZE_XLARGE -> ResTableConfig.SCREEN_LAYOUT.SIZE_XLARGE
      else -> ResTableConfig.SCREEN_LAYOUT.SIZE_ANY
    }

  val screenLayoutLong =
    when (config.getScreenLayoutLong()) {
      ConfigurationOuterClass.Configuration.ScreenLayoutLong.SCREEN_LAYOUT_LONG_LONG -> ResTableConfig.SCREEN_LAYOUT.SCREENLONG_YES
      ConfigurationOuterClass.Configuration.ScreenLayoutLong.SCREEN_LAYOUT_LONG_NOTLONG -> ResTableConfig.SCREEN_LAYOUT.SCREENLONG_NO
      else -> ResTableConfig.SCREEN_LAYOUT.SCREENLONG_ANY
    }

  val screenRound =
    when (config.getScreenRound()) {
      ConfigurationOuterClass.Configuration.ScreenRound.SCREEN_ROUND_ROUND -> ResTableConfig.SCREEN_LAYOUT2.SCREENROUND_YES
      ConfigurationOuterClass.Configuration.ScreenRound.SCREEN_ROUND_NOTROUND -> ResTableConfig.SCREEN_LAYOUT2.SCREENROUND_NO
      else -> ResTableConfig.SCREEN_LAYOUT2.SCREENROUND_ANY
    }

  val wideGamutColor =
    when (config.getWideColorGamut()) {
      ConfigurationOuterClass.Configuration.WideColorGamut.WIDE_COLOR_GAMUT_WIDECG -> ResTableConfig.COLOR_MODE.WIDE_GAMUT_YES
      ConfigurationOuterClass.Configuration.WideColorGamut.WIDE_COLOR_GAMUT_NOWIDECG -> ResTableConfig.COLOR_MODE.WIDE_GAMUT_NO
  ...
  val orientation =
    when (config.getOrientation()) {
      ConfigurationOuterClass.Configuration.Orientation.ORIENTATION_PORT -> ResTableConfig.ORIENTATION.PORT
      ConfigurationOuterClass.Configuration.Orientation.ORIENTATION_LAND -> ResTableConfig.ORIENTATION.LAND
      ConfigurationOuterClass.Configuration.Orientation.ORIENTATION_SQUARE -> ResTableConfig.ORIENTATION.SQUARE
      else -> ResTableConfig.ORIENTATION.ANY
    }

  val uiModeType =
    when (config.getUiModeType()) {
      ConfigurationOuterClass.Configuration.UiModeType.UI_MODE_TYPE_NORMAL -> ResTableConfig.UI_MODE.TYPE_NORMAL
      ConfigurationOuterClass.Configuration.UiModeType.UI_MODE_TYPE_DESK -> ResTableConfig.UI_MODE.TYPE_DESK
      ConfigurationOuterClass.Configuration.UiModeType.UI_MODE_TYPE_CAR -> ResTableConfig.UI_MODE.TYPE_CAR
      ConfigurationOuterClass.Configuration.UiModeType.UI_MODE_TYPE_TELEVISION -> ResTableConfig.UI_MODE.TYPE_TELEVISION
      ConfigurationOuterClass.Configuration.UiModeType.UI_MODE_TYPE_APPLIANCE -> ResTableConfig.UI_MODE.TYPE_APPLIANCE
      ConfigurationOuterClass.Configuration.UiModeType.UI_MODE_TYPE_WATCH -> ResTableConfig.UI_MODE.TYPE_WATCH
      ConfigurationOuterClass.Configuration.UiModeType.UI_MODE_TYPE_VRHEADSET -> ResTableConfig.UI_MODE.TYPE_VR_HEADSET
      else -> ResTableConfig.UI_MODE.TYPE_ANY
    }

  val uiModeNight =
    when (config.getUiModeNight()) {
      ConfigurationOuterClass.Configuration.UiModeNight.UI_MODE_NIGHT_NIGHT -> ResTableConfig.UI_MODE.NIGHT_YES
      ConfigurationOuterClass.Configuration.UiModeNight.UI_MODE_NIGHT_NOTNIGHT -> ResTableConfig.UI_MODE.NIGHT_NO
  ...
  val touchscreen =
    when (config.getTouchscreen()) {
      ConfigurationOuterClass.Configuration.Touchscreen.TOUCHSCREEN_NOTOUCH -> ResTableConfig.TOUCHSCREEN.NOTOUCH
      ConfigurationOuterClass.Configuration.Touchscreen.TOUCHSCREEN_STYLUS -> ResTableConfig.TOUCHSCREEN.STYLUS
      ConfigurationOuterClass.Configuration.Touchscreen.TOUCHSCREEN_FINGER -> ResTableConfig.TOUCHSCREEN.FINGER
      else -> ResTableConfig.TOUCHSCREEN.ANY
    }

  val keysHidden =
    when (config.getKeysHidden()) {
      ConfigurationOuterClass.Configuration.KeysHidden.KEYS_HIDDEN_KEYSEXPOSED -> ResTableConfig.INPUT_FLAGS.KEYSHIDDEN_NO
      ConfigurationOuterClass.Configuration.KeysHidden.KEYS_HIDDEN_KEYSHIDDEN -> ResTableConfig.INPUT_FLAGS.KEYSHIDDEN_YES
      ConfigurationOuterClass.Configuration.KeysHidden.KEYS_HIDDEN_KEYSSOFT -> ResTableConfig.INPUT_FLAGS.KEYSHIDDEN_SOFT
      else -> ResTableConfig.INPUT_FLAGS.KEYSHIDDEN_ANY
    }

  val keyboard =
    when (config.getKeyboard()) {
      ConfigurationOuterClass.Configuration.Keyboard.KEYBOARD_NOKEYS -> ResTableConfig.KEYBOARD.NOKEYS
      ConfigurationOuterClass.Configuration.Keyboard.KEYBOARD_QWERTY -> ResTableConfig.KEYBOARD.QWERTY
      ConfigurationOuterClass.Configuration.Keyboard.KEYBOARD_TWELVEKEY -> ResTableConfig.KEYBOARD.TWELVEKEY
      else -> ResTableConfig.KEYBOARD.ANY
    }

  val navHidden =
    when (config.getNavHidden()) {
      ConfigurationOuterClass.Configuration.NavHidden.NAV_HIDDEN_NAVHIDDEN -> ResTableConfig.INPUT_FLAGS.NAVHIDDEN_YES
      ConfigurationOuterClass.Configuration.NavHidden.NAV_HIDDEN_NAVEXPOSED -> ResTableConfig.INPUT_FLAGS.NAVHIDDEN_NO
      else -> ResTableConfig.INPUT_FLAGS.NAVHIDDEN_ANY
    }

  val navigation =
    when (config.getNavigation()) {
      ConfigurationOuterClass.Configuration.Navigation.NAVIGATION_NONAV -> ResTableConfig.NAVIGATION.NONAV
      ConfigurationOuterClass.Configuration.Navigation.NAVIGATION_DPAD -> ResTableConfig.NAVIGATION.DPAD
      ConfigurationOuterClass.Configuration.Navigation.NAVIGATION_TRACKBALL -> ResTableConfig.NAVIGATION.TRACKBALL
      ConfigurationOuterClass.Configuration.Navigation.NAVIGATION_WHEEL -> ResTableConfig.NAVIGATION.WHEEL
      else -> ResTableConfig.NAVIGATION.ANY
    }

  val grammaticalGender =
    when (config.grammaticalGender) {
      ConfigurationOuterClass.Configuration.GrammaticalGender.GRAM_GENDER_NEUTER -> ResTableConfig.GRAMMATICAL_GENDER.NEUTER
      ConfigurationOuterClass.Configuration.GrammaticalGender.GRAM_GENDER_FEMININE -> ResTableConfig.GRAMMATICAL_GENDER.FEMININE
      ConfigurationOuterClass.Configuration.GrammaticalGender.GRAM_GENDER_MASCULINE -> ResTableConfig.GRAMMATICAL_GENDER.MASCULINE
  ...
  val configDescription =
    ConfigDescription(
      ResTableConfig(
        ...
        screenLayout = (screenLayoutDir.toInt() or screenLayoutLong.toInt() or screenLayoutSize.toInt()).toByte(),
...
fun deserializeBinPrimitiveFromPb(primitive: Resources.Primitive, logger: ILogger?): BinaryPrimitive? {

  val (type, deviceValue) =
    when (primitive.getOneofValueCase()) {
      Resources.Primitive.OneofValueCase.NULL_VALUE -> Pair(ResValue.DataType.NULL, ResValue.NullFormat.UNDEFINED)
      Resources.Primitive.OneofValueCase.EMPTY_VALUE -> Pair(ResValue.DataType.NULL, ResValue.NullFormat.EMPTY)
      ...
      Resources.Primitive.OneofValueCase.DIMENSION_VALUE -> Pair(ResValue.DataType.DIMENSION, primitive.getDimensionValue())
      Resources.Primitive.OneofValueCase.FRACTION_VALUE -> Pair(ResValue.DataType.FRACTION, primitive.getFractionValue())
      Resources.Primitive.OneofValueCase.INT_DECIMAL_VALUE -> Pair(ResValue.DataType.INT_DEC, primitive.getIntDecimalValue())
      Resources.Primitive.OneofValueCase.INT_HEXADECIMAL_VALUE -> Pair(ResValue.DataType.INT_HEX, primitive.getIntHexadecimalValue())
      ...
      Resources.Primitive.OneofValueCase.COLOR_ARGB8_VALUE -> Pair(ResValue.DataType.INT_COLOR_ARGB8, primitive.getColorArgb8Value())
      Resources.Primitive.OneofValueCase.COLOR_RGB8_VALUE -> Pair(ResValue.DataType.INT_COLOR_RGB8, primitive.getColorRgb8Value())
      Resources.Primitive.OneofValueCase.COLOR_ARGB4_VALUE -> Pair(ResValue.DataType.INT_COLOR_ARGB4, primitive.getColorArgb4Value())
      Resources.Primitive.OneofValueCase.COLOR_RGB4_VALUE -> Pair(ResValue.DataType.INT_COLOR_RGB4, primitive.getColorRgb4Value())
...
fun deserializeStringFromPb(string: Resources.String, valuePool: StringPool) = BasicString(valuePool.makeRef(string.getValue()))

fun deserializeRawFromPb(string: Resources.RawString, valuePool: StringPool) = RawString(valuePool.makeRef(string.getValue()))

fun deserializeStyledStrFromPb(string: Resources.StyledString, valuePool: StringPool): StyledString {
...
fun deserializeFileRefFromPb(file: Resources.FileReference, valuePool: StringPool, config: ConfigDescription): FileReference {

  val fileRef = FileReference(valuePool.makeRef(file.getPath(), StringPool.Context(StringPool.Context.Priority.HIGH.priority, config)))
  fileRef.type = deserializeFileTypeFromPb(file.getType())

  return fileRef
}

fun deserializeAttrFromPb(attr: Resources.Attribute, sourcePool: ResStringPool, logger: ILogger?): AttributeResource? {
  ...
  for (symbol in attr.getSymbolList()) {
    ...
    attrResource.symbols.add(AttributeResource.Symbol(reference, symbol.getValue(), symbol.getType().toByte()))
  }
...
fun deserializeStyleableFromPb(styleable: Resources.Styleable, sourcePool: ResStringPool, logger: ILogger?): Styleable? {
...
fun deserializeMacroFromPb(
  ...
  for (untranslatable in pbMacro.untranslatableSectionsList) {
    untranslatableList.add(UntranslatableSection(untranslatable.startIndex.toInt(), untranslatable.endIndex.toInt()))
  }
  ...
  for (namespace in pbMacro.namespaceStackList) {
    aliasNamespaces.add(Macro.Namespace(namespace.prefix, namespace.packageName, namespace.isPrivate))
  }
...
fun deserializeItemFromPb(item: Resources.Item, valuePool: StringPool, config: ConfigDescription, logger: ILogger?): Item? =
  when (item.getValueCase()) {
    ...
    Resources.Item.ValueCase.STYLED_STR -> deserializeStyledStrFromPb(item.getStyledStr(), valuePool)
    ...
    when {
      ...
      value.hasCompoundValue() -> {
        ...
        when (compoundValue.getValueCase()) {
          Resources.CompoundValue.ValueCase.ATTR -> deserializeAttrFromPb(compoundValue.getAttr(), sourcePool, logger)
          Resources.CompoundValue.ValueCase.STYLE -> deserializeStyleFromPb(compoundValue.getStyle(), valuePool, config, sourcePool, logger)
          Resources.CompoundValue.ValueCase.STYLEABLE -> deserializeStyleableFromPb(compoundValue.getStyleable(), sourcePool, logger)
          Resources.CompoundValue.ValueCase.ARRAY -> deserializeArrayFromPb(compoundValue.getArray(), valuePool, config, sourcePool, logger)
          ...
          Resources.CompoundValue.ValueCase.MACRO -> deserializeMacroFromPb(compoundValue.getMacro(), valuePool, config, sourcePool, logger)
          else -> {
...
fun deserializePackageFromPb(
  ...
  val packageId = if (original.hasPackageId()) original.getPackageId().getId().toByte() else 0.toByte()

  val idIndex = mutableMapOf<Int, ResourceName>()

  val resourcePackage = table.createPackageAllowingDuplicateNames(original.getPackageName(), packageId)
    ...
    for (entry in group.getEntryList()) {
      ...
      if (entry.hasOverlayableItem()) {
        ...
        if (overlayableItem.getOverlayableIdx() >= overlayables.size) {
          val errorMsg = "Illegal value for overlayable id '%s'. Because only '%s' overlayables" + "exist in proto."
          logger?.error(null, errorMsg, overlayableItem.overlayableIdx, overlayables.size)
          return false
        }
        val resourceOverlayable =
          deserializeOverlayableFromPb(overlayableItem, overlayables[overlayableItem.getOverlayableIdx()], sourcePool, logger)
      ...
      if (resourceId.isValidId()) {
        idIndex[resourceId] = ResourceName(resourcePackage.name, resourceGroup.type, resourceEntry.name)
      }
      ...
      for (configValue in entry.getConfigValueList()) {
        ...
        val resourceConfigValue = resourceEntry.findOrCreateValue(resourceConfig, config.getProduct())
        ...
        resourceConfigValue.value = deserializeValueFromPb(configValue.getValue(), table.stringPool, resourceConfig, sourcePool, logger)
...
fun deserializeTableFromPb(table: Resources.ResourceTable, outTable: ResourceTable, logger: ILogger?): Boolean {

  val sourcePool = ResStringPool.get(table.getSourcePool().getData().asReadOnlyByteBuffer(), table.getSourcePool().getSerializedSize())
