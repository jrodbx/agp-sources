 ...
 *
 * There can be more than one attribute associated to each [org.gradle.api.artifacts.Configuration] object, where each represents a
...
interface ProductFlavorAttr : Named {
  companion object {
     ...
     *
     * @param flavorDimension The name of the flavor dimension, as specified in the Android Gradle Plugin DSL.
     */
    @JvmStatic
