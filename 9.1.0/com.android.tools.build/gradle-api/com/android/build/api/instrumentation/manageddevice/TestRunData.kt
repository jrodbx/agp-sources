...
interface TestRunData {
   ...
   */
  @get:Incubating val variantName: String
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val testRunId: String
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val deviceName: String
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val outputDirectory: Directory
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val coverageOutputDirectory: Directory
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val additionalTestOutputDir: Directory?
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val additionalInstallOptions: List<String>
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val helperApks: Set<File>
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val projectPath: String
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val testData: StaticTestData
}
