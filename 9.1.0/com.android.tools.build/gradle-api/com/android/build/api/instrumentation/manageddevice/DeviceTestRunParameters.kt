 ...
 *
 * @param InputT The specialized input type for the custom managed device associated with the [DeviceTestRunTaskAction], generated by the
 *   corresponding [DeviceTestRunConfigureAction]
...
interface DeviceTestRunParameters<InputT : DeviceTestRunInput> {
   ...
   */
  @get:Incubating val deviceInput: InputT

  /** The output from the [DeviceSetupTaskAction] for managed device the test is being run on. */
  @get:Incubating val setupResult: DirectoryProperty
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val testRunData: TestRunData
}
