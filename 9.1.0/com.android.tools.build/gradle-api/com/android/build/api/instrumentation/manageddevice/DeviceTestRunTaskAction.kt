 ...
 *
 * @param InputT The Custom Managed Device specific input to be passed in as part of the [DeviceTestRunParameters] when the tests are run.
...
interface DeviceTestRunTaskAction<InputT : DeviceTestRunInput> {
   ...
   * @return returns true if and only if all tests passed. Determines if the task succeeds or fails.
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @Incubating fun runTests(params: DeviceTestRunParameters<InputT>): Boolean
}
