...
/**
 * Final values for the Android Test data that can be passed to test runners. This should not be used as task input.
 *
...
interface StaticTestData {
   ...
   */
  @get:Incubating val applicationId: String
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val testedApplicationId: String?

  /**
   * The instrumentation target application id.
   *
   * If this is a self instrumenting test, then this value will be the same a [applicationId]. Otherwise, the instrumentation target will be
   * the same as [testedApplicationId].
   *
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val instrumentationTargetPackageId: String
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val instrumentationRunner: String
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val instrumentationRunnerArguments: Map<String, String>

  /** @suppress Do not use from production code. This API is exposed for prototype. */
  @get:Incubating val animationsDisabled: Boolean

  /** @suppress Do not use from production code. This API is exposed for prototype. */
  @get:Incubating val isTestCoverageEnabled: Boolean
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val minSdkVersion: AndroidVersion

  /** @suppress Do not use from production code. This API is exposed for prototype. */
  @get:Incubating val isLibrary: Boolean

  /** @suppress Do not use from production code. This API is exposed for prototype. */
  @get:Incubating val flavorName: String
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val testApk: File
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val testDirectories: List<File?>
   ...
   * @suppress Do not use from production code. This API is exposed for prototype.
   */
  @get:Incubating val testedApkFinder: (DeviceConfigProvider) -> List<File>
}
