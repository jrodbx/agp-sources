...
interface Prefab {
   ...
   *
   * The name of the library must match the name of the library used by the external native build. For an ndk-build project, this is the
   * LOCAL_MODULE option. For a CMake project, this is the name of the target.
   *
  ...
  /**
   * The name of the library file, if it does not match the convention of lib<name>.so or lib<name>.a.
   *
   * This option can be used to specify the name of the library file if it does not match the name of the library in the build system. For
   * example, if a CMake target is named "mylib" but the name of the library file was overridden to "mylib.so" rather than the default of
