 ...
 * [Add C and C++ Code to Your Project](https://developer.android.com/studio/projects/add-native-code.html). You can also read more
 * documentation about [the Android CMake toolchain](https://developer.android.com/ndk/guides/cmake.html).
 */
interface CmakeFlags {
   ...
   *
   * For example, if your CMake project defines multiple libraries and executables, you can tell Gradle to build only a subset of those
   * outputs as follows:
   * ```
   * android {
   *     // Similar to other properties in the defaultConfig block, you can override
   ...
   * ```
   *
   * If you don't configure this property, Gradle builds all executables and shared object libraries that you define in your CMake project.
   * However, by default, Gradle packages only the shared libraries in your APK.
   *
   * since 2.2.0
   */
