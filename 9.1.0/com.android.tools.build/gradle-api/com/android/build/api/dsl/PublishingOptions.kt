 ...
 *
 * To publish sources & javadoc jar apart from AAR, use [withSourcesJar] and [withJavadocJar]. The following sets up publishing of sources &
 * javadoc jar in two different publishing mechanisms.
 *
 * ```
 * android {
 *     publishing {
