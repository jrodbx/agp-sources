...
interface SdkComponents {
   ...
   *
   * The returned [Provider] can be used by tasks requiring aidl tools as input with [org.gradle.api.tasks.Nested]. See [Aidl] for more
   * details.
   */
   ...
   *
   * The returned [Provider] can be used by tasks requiring AAPT2 as input with [org.gradle.api.tasks.Nested]. See [Aapt2] for more details.
   */
