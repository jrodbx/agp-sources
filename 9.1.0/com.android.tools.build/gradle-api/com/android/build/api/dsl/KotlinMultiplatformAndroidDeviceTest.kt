...
interface KotlinMultiplatformAndroidDeviceTest {
  ...
  /**
   * Test instrumentation runner class name. This is a fully qualified class name of the runner See
   * [instrumentation](http://developer.android.com/guide/topics/manifest/instrumentation-element.html).
   */
  ...
  @get:Incubating val multidex: MultiDexConfig

  @Incubating fun multidex(action: MultiDexConfig.() -> Unit)
}
