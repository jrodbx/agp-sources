...
interface Packaging {
  ...
  /**
   * The set of patterns where the first occurrence is packaged in the APK. First pick patterns do get packaged in the APK, but only the
  ...
  @Deprecated("This property is deprecated. Use resources.merges instead.", replaceWith = ReplaceWith("resources.merges"))
  val merges: MutableSet<String>

  /** The set of patterns for native library that should not be stripped of debug symbols. */
  @Deprecated("This property is deprecated. Use jniLibs.keepDebugSymbols instead.", replaceWith = ReplaceWith("jniLibs.keepDebugSymbols"))
   ...
   */
  @Deprecated("This method is deprecated. Use resources.merges.add() instead.", replaceWith = ReplaceWith("resources.merges.add(pattern)"))
