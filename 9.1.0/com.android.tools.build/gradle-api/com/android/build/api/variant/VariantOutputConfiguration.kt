...
interface VariantOutputConfiguration {
   ...
   *
   * When support for Splits/Multi-APKs is turned on, the output will change from one [SINGLE] output to multiple [ONE_OF_MANY] outputs,
   * each with different [filters] values.
   *
  ...
  enum class OutputType {
    ...
    /**
     * Type of multiple output. This type will be used by multiple outputs and each can be differentiated with
     * [VariantOutputConfiguration.filters]
     */
    ONE_OF_MANY,

    /**
     * Output for Universal APK. This is only valid if Splits/Multi-APK is on and universal mode was turned on (see
     * [com.android.build.api.dsl.AbiSplit.isUniversalApk])
     */
    UNIVERSAL,
  }
   ...
   *
   * If the list is empty this means there is no filter associated to this output. This is typically the case for [OutputType.SINGLE]
   */
