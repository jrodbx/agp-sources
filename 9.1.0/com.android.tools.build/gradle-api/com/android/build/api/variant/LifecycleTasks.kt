 ...
 *
 * A lifecycle task usually does not have any processing associated with it but represent a specific location in the build process that can
 * be used to register dependent tasks. These are also [Task]s that can be invoked by users which provide a consumable output.
 */
