...
interface DslLifecycle<T : Any> {
  ...
  /**
   * API to customize the DSL Objects programmatically after they have been evaluated from the build files and before used in the build
   * process next steps like variant or tasks creation.
   *
