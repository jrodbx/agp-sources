...
interface DexPackagingOptions {
   ...
   *
   * This property is initialized from the [com.android.build.api.dsl.DexPackaging.useLegacyPackaging] DSL element, if set. If this property
   * and the DSL are unset, dex files will be uncompressed when minSdk >= 28. If this property is set, the value will be fed directly to the
