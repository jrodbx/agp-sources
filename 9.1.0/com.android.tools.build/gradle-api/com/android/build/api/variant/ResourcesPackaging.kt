...
interface ResourcesPackaging {
  ...
  /**
   * The set of patterns for which the first occurrence is packaged in the APK. For each java resource APK entry path matching one of these
   * patterns, only the first java resource found with that path gets packaged in the APK.
   *
  ...
  /**
   * The set of patterns for which matching java resources are merged. For each java resource APK entry path matching one of these patterns,
   * all java resources with that path are concatenated and packaged as a single entry in the APK.
   *
