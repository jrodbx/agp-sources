...
interface BundleConfig {
   ...
   * @param file the [Provider] of [RegularFile] that can be wired from a [org.gradle.api.Task] output or an existing file in the project
   *   directory.
   */
  fun addMetadataFile(metadataDirectory: String, file: Provider<RegularFile>)
}
