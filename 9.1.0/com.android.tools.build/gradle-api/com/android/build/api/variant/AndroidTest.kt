 ...
 *
 * This object is accessible on subtypes of [Variant] that implement [HasDeviceTests], via [HasDeviceTests.androidTest]. It is also part of
 * [Variant.nestedComponents].
 *
 * The presence of this component in a variant is controlled by [HasDeviceTestsBuilder.deviceTests.enable] which is accessible on subtypes
 * of [VariantBuilder] that implement [HasDeviceTestsBuilder]
 */
