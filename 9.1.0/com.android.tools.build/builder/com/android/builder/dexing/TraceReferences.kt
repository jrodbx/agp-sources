...
fun runTraceReferences(sourceFiles: List<Path>, libraryFiles: List<Path>, libraryInMemoryClasses: Map<String, ByteArray>) {
  TraceReferences.run(
...
private class InMemoryClassFileResourceProvider(private val classes: Map<String, ByteArray>) : ClassFileResourceProvider {
  ...
  override fun getProgramResource(descriptor: String): ProgramResource? {
    return classes[descriptor]?.let { ProgramResource.fromBytes(origin, ProgramResource.Kind.CF, it, setOf()) }
  }
}
