...
class D8DesugarGraphConsumerAdapter(private val desugarGraphUpdater: DependencyGraphUpdater<File>) : DesugarGraphConsumer {
  ...
  /**
   * Returns the path to the regular file if the given [Origin] points to a regular file, or the containing jar if the given [Origin] points
   * to a jar entry.
   */
