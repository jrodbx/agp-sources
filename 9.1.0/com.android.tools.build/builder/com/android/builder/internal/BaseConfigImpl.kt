...
abstract class BaseConfigImpl : Serializable, BaseConfig {
  ...
  private val mProguardFiles: MutableList<File> = Lists.newArrayList()
  private val mConsumerProguardFiles: MutableList<File> = Lists.newArrayList()
  private val mTestProguardFiles: MutableList<File> = Lists.newArrayList()
  private val mManifestPlaceholders: MutableMap<String, Any> = Maps.newHashMap()
