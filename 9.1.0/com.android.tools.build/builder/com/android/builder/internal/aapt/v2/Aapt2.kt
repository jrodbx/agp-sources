 ...
 *
 * Methods throw [Aapt2Exception] for invalid input (e.g. syntax error in a source file) and [Aapt2InternalException] if there is an
 * internal issue running AAPT itself.
 */
interface Aapt2 {
  ...
  /** Perform the requested conversion between proto/binary resources. Throws [Aapt2Exception] on failure. */
