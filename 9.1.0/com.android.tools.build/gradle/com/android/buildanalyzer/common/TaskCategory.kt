...
/**
 * Enum class for Category-Based Task Analyzer for Build Analyzer. Each field corresponds to a specific atomic function/execution of a task.
 *
 * @param isPrimary indicates whether the category would be the primary category of some task
 * @param description the description of the category which is shown to the user, all primary categories should have descriptions.
 */
