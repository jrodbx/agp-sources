...
class AnalysisAdapter(val impl: AnalysisCallback) : ResourceShrinker.ReferenceChecker {
  ...
  override fun referencedStaticField(internalName: String, fieldName: String) = impl.referencedStaticField(internalName, fieldName)
  ...
  override fun startMethodVisit(methodReference: MethodReference) = impl.startMethodVisit(methodReference)

  override fun endMethodVisit(methodReference: MethodReference) = impl.endMethodVisit(methodReference)
}
