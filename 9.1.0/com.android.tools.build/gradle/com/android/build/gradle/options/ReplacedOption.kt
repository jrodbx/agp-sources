 ...
 *
 * Note that replaced options are different from removed options. Removed options belong to the [Option] subclass where they were first
 * introduced, and should not be put in this class.
 */
enum class ReplacedOption(override val propertyName: String, private val replacedVersion: Version, private val additionalMessage: String) :
  Option<String> {
  ...
  // it here.
  @Suppress("unused")
  DEPRECATED_NDK_COMPILE_LEASE("android.deprecatedNdkCompileLease", VERSION_BEFORE_4_0, "NdkCompile is no longer supported"),
  @Suppress("unused")
  ...
  @Suppress("unused")
  ENABLE_PREFAB("android.enablePrefab", VERSION_4_1, "This property has been replaced by android.buildFeatures.prefab (DSL)"),
