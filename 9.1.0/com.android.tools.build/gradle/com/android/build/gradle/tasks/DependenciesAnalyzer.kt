...
/**
 * Class responsible for analyzing a compiled class and getting a list of external dependencies used by the class. It does that by using
 * class visitors that 'visit' the class components (header, fields, annotations and method signatures) and get the class names of the super
 * class, interfaces, exceptions, field and method owners, as well as the types used in attributes, method returns and method parameters.
 */
class DependenciesAnalyzer {

  private val asmVersion = ASM_API_VERSION

  private val primitives = setOf("void", "boolean", "byte", "char", "short", "int", "long", "float", "double")
  ...
  inner class DependenciesClassVisitor(val reader: ClassReader) : ClassVisitor(asmVersion) {
    ...
    /** Visit the class header (superclass, interfaces) and save the package names of all the types found */
    ...
    override fun visitMethod(access: Int, name: String?, desc: String?, signature: String?, exceptions: Array<out String>?): MethodVisitor {
      ...
      // Parameter types
      methodType.argumentTypes.forEach { addTypeName(it, access) }
