 ...
 * 4. Optionally, delete the BUILD modules and prebuilts for the old version of Prefab. This should be done unless AGP will continue testing
 *    both the new and old version (uncommon).
 */
...
fun getPrefabFromMaven(projectOptions: ProjectOptions, services: TaskCreationServices): FileCollection {
  ...
  services.dependencies.add(config.name, "com.google.prefab:cli:${version}:all")
