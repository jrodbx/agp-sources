...
/**
 * Creates an [ApkCreatorFactory] based on the definitions in the project. This is only to be used with the incremental packager.
 *
 * @param debuggableBuild whether the [ApkCreatorFactory] will be used to create a debuggable archive
 * @return the factory
 */
fun fromProjectProperties(debuggableBuild: Boolean): ApkCreatorFactory {
  ...
  if (debuggableBuild) {
    ...
    options.compressor = DeflateExecutionCompressor(compressionExecutor, Deflater.DEFAULT_COMPRESSION)
