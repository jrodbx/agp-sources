...
data class SigningConfigData(
  ...
  companion object {
    ...
    fun fromExperimentalPropertiesSigningConfig(experimentalProperties: MapProperty<String, Any>): SigningConfigData? {
      ...
      ModulePropertyKey.OptionalString.ANDROID_PRIVACY_SANDBOX_LOCAL_DEPLOYMENT_SIGNING_STORE_FILE.getValue(experimentalProperties.get())
        ?: return null
      return SigningConfigData(
        ModulePropertyKey.OptionalString.ANDROID_PRIVACY_SANDBOX_LOCAL_DEPLOYMENT_SIGNING_NAME.getValue(experimentalProperties.get())
          ?: SigningOptions.SIGNING_CONFIG_NAME,
        ModulePropertyKey.OptionalString.ANDROID_PRIVACY_SANDBOX_LOCAL_DEPLOYMENT_SIGNING_STORE_TYPE.getValue(experimentalProperties.get()),
        File(
        ...
        ModulePropertyKey.OptionalString.ANDROID_PRIVACY_SANDBOX_LOCAL_DEPLOYMENT_SIGNING_KEY_ALIAS.getValue(experimentalProperties.get())
