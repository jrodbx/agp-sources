...
private constructor(
  ...
  class Builder(
    ...
    fun setOutputPath(outputPath: Path) = apply { this.outputPath = outputPath }

    fun setNamespace(namespace: String) = apply { this.namespace = namespace }

    fun setBuildConfigName(buildConfigName: String) = apply { this.buildConfigName = buildConfigName }
    ...
    fun addItem(name: String, field: BuildConfigField<out Serializable>) = apply { buildConfigFields[name] = field }
