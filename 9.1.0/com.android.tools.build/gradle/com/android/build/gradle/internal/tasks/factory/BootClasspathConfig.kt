...
interface BootClasspathConfig {
  ...
  /** The boot classpath to be used during compilation with all available additional jars including all optional libraries. */
  val fullBootClasspath: FileCollection
  val fullBootClasspathProvider: Provider<List<RegularFile>>

  /**
   * The boot classpath to be used during compilation with all available additional jars but only the requested optional ones.
   *
   ...
   *
   * This is designed to mock android.jar from a configuration that contains it, via Artifact Transforms.
   */
