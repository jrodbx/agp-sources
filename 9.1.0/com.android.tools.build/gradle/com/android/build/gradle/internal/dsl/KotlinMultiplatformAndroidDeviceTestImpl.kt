...
abstract class KotlinMultiplatformAndroidDeviceTestImpl @Inject constructor(val dslServices: DslServices) :
  ...
  override val installation: Installation = dslServices.newDecoratedInstance(AdbOptions::class.java, dslServices)
  ...
  override val signing = dslServices.newDecoratedInstance(SigningConfig::class.java, BuilderConstants.DEBUG, dslServices)
  ...
  override val multidex: MultiDexConfigImpl = dslServices.newDecoratedInstance(MultiDexConfigImpl::class.java, dslServices)
