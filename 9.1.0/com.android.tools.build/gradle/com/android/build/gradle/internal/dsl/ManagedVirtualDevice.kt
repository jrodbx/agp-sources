...
open class ManagedVirtualDevice @Inject constructor(private val name: String) : ManagedVirtualDevice {
  ...
  @get:Internal override var apiLevel: Int by this::sdkVersion

  @get:Internal override var apiPreview: String? by this::sdkPreview
  ...
  @get:Input var sdkMinorVersion: Int = 0
  ...
  @get:Optional @get:Input override var sdkExtensionVersion: Int? = null

  @get:Input override var systemImageSource = "google"

  @get:Input override var require64Bit = false

  @get:Internal override var pageAlignment: PageAlignment = PageAlignment.DEFAULT_FOR_SDK_VERSION

  @get:Optional @get:Input override var testedAbi: String? = null
    ...
    get() =
      when (pageAlignment) {
        ...
        PageAlignment.FORCE_4KB_PAGES -> PAGE_EMPTY_SUFFIX
          ...
          if (sdkVersion > 36 && pageAlignment == PageAlignment.DEFAULT_FOR_SDK_VERSION) {
            logger.warning(
              """
