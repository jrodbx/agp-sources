...
data class SettingsConfiguration(
  ...
  /** Specifies build type configuration for the selected generator. Example, MinSizeRel */
  val configurationType: String? = null,
  /** The environments this configuration depends on. Any custom environment can be used. */
  val inheritEnvironments: List<String> = listOf(),
  /**
   * The directory in which CMake generates build scripts for the chosen generator. Supported macros include ${workspaceRoot},
   * ${workspaceHash}, ${projectFile}, ${projectDir}, ${thisFile}, ${thisFileDir}, ${name}, ${generator}, ${env.VARIABLE}.
   */
  val buildRoot: String? = null,
  /**
   * The directory in which CMake generates install targets for the chosen generator. Supported macros include ${workspaceRoot},
   * ${workspaceHash}, ${projectFile}, ${projectDir}, ${thisFile}, ${thisFileDir}, ${name}, ${generator}, ${env.VARIABLE}.
   */
  ...
  /** specifies the full path to the CMake program executable, including the file name and extension. */
  ...
  /** A list of CMake variables. The name value pairs are passed to CMake as -Dname1=value1 -Dname2=value2, etc. */
