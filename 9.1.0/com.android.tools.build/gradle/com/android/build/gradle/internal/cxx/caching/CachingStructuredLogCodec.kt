...
/** Call EncodedObjectFileCacheEvent#decode in a pattern that can be used directly with [readStructuredLogs]. */
fun decodeObjectFileCacheEvent(encoded: EncodedObjectFileCacheEvent, decoder: StringDecoder) = encoded.decode(decoder)
