...
fun getLocalCustomLintChecksForModel(project: Project, issueReporter: IssueReporter): ImmutableList<File> {
...
private fun getLocalCustomLintChecks(lintChecks: Configuration, lenientMode: Boolean): ArtifactCollection {
  return lintChecks.incoming
    .artifactView { config: ViewConfiguration ->
      config.attributes { attributes: AttributeContainer ->
        ...
        attributes.attribute(AndroidArtifacts.ARTIFACT_TYPE, AndroidArtifacts.ArtifactType.JAR.type)
      }
