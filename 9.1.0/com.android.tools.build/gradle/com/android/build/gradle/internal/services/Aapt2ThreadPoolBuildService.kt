...
abstract class Aapt2ThreadPoolBuildService : BuildService<Aapt2ThreadPoolBuildService.Params>, AutoCloseable {
  ...
  class RegistrationAction(project: Project, projectOptions: ProjectOptions) :
    ServiceRegistrationAction<Aapt2ThreadPoolBuildService, Params>(project, Aapt2ThreadPoolBuildService::class.java) {
    private val aapt2ThreadPoolSize = computeMaxAapt2Daemons(projectOptions)
...
fun computeMaxAapt2Daemons(projectOptions: ProjectOptions): Int {
  return projectOptions.get(IntegerOption.AAPT2_THREAD_POOL_SIZE)
    ?: Integer.min(MAX_AAPT2_THREAD_POOL_SIZE, ForkJoinPool.getCommonPoolParallelism())
}
