...
internal abstract class KotlinMultiplatformAndroidLibraryExtensionImpl
@Inject
constructor(
  ...
  final override val localDependencySelection: DependencySelection =
    dslServices.newDecoratedInstance(DependencySelectionImpl::class.java, dslServices, objectFactory)
  ...
  override val androidResources: LibraryAndroidResources =
    dslServices.newDecoratedInstance(LibraryAndroidResourcesImpl::class.java, dslServices, false)
  ...
  val compileSdkVersion: String? by lazy { compileSdkDelegate.compileSdkVersion }
  ...
  internal val minSdkVersion: MutableAndroidVersion
    get() {
      return MutableAndroidVersion(_minSdk?.apiLevel, _minSdk?.codeName).sanitize().let { MutableAndroidVersion(it.apiLevel, it.codename) }
    }
  ...
  override fun withHostTestBuilder(
    ...
    androidTestOnJvmBuilder = withTestBuilder(KmpAndroidCompilationType.HOST_TEST, androidTestOnJvmBuilder)
    androidTestOnJvmOptions = dslServices.newDecoratedInstance(KotlinMultiplatformAndroidHostTestImpl::class.java, dslServices)

    androidTestOnJvmBuilder!!.action()
    compilationEnabledCallback(androidTestOnJvmBuilder!!)
    return dslServices.newInstance(HasConfigurableValueImpl::class.java, androidTestOnJvmOptions!!)
  ...
  override fun withDeviceTestBuilder(
    ...
    androidTestOnDeviceBuilder = withTestBuilder(KmpAndroidCompilationType.DEVICE_TEST, androidTestOnDeviceBuilder)
    androidTestOnDeviceOptions = dslServices.newDecoratedInstance(KotlinMultiplatformAndroidDeviceTestImpl::class.java, dslServices)

    androidTestOnDeviceBuilder!!.action()
    compilationEnabledCallback(androidTestOnDeviceBuilder!!)
    return dslServices.newInstance(HasConfigurableValueImpl::class.java, androidTestOnDeviceOptions!!)
