...
class BoundingBoxGetMethodInjector(private val modelInfo: ModelInfo) : MethodInjector() {
  ...
  override fun inject(classBuilder: TypeSpec.Builder, tensorInfo: TensorInfo) {
    ...
    val methodName = MlNames.formatGetterName(tensorInfo.identifierName, getOutputParameterTypeName(tensorInfo))
    val methodSpec =
      MethodSpec.methodBuilder(methodName)
        ...
        .addStatement(
          "\$T originalBoxes = \$T.convert(\$L, \$L, \$L, \$T.Type.\$L, \$T.CoordinateType.\$L, \$L, \$L)",
        ...
        .addStatement(
          "processedBoxes.add(\$L.inverseTransform(box, \$L, \$L))",
