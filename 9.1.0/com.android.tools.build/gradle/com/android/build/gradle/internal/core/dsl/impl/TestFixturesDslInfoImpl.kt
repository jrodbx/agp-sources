...
internal class TestFixturesDslInfoImpl(
  ...
  override val namespace: Provider<String> = mainVariantDslInfo.namespace.map { "$it.$testFixturesFeatureName" }
  override val applicationId: Property<String> =
    services.newPropertyBackingDeprecatedApi(String::class.java, namespace.map { "$it${computeApplicationIdSuffix()}" })
