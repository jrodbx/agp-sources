 ...
 * [com.android.build.gradle.tasks.TransformClassesWithAsmTask], when the stack frames computation mode is
...
abstract class RecalculateStackFramesTask : NewIncrementalTask() {
  ...
  @get:Classpath @get:Incremental abstract val classesInputDir: ConfigurableFileCollection

  @get:Classpath @get:Incremental abstract val jarsInputDir: ConfigurableFileCollection

  @get:CompileClasspath abstract val bootClasspath: ConfigurableFileCollection

  @get:CompileClasspath abstract val referencedClasses: ConfigurableFileCollection
  ...
  class CreationAction(creationConfig: ComponentCreationConfig) :
    VariantTaskCreationAction<RecalculateStackFramesTask, ComponentCreationConfig>(creationConfig),
    InstrumentationTaskCreationAction by InstrumentationTaskCreationActionImpl(creationConfig) {
    ...
    override fun configure(task: RecalculateStackFramesTask) {
      ...
      task.referencedClasses
        ...
        .from(instrumentationCreationConfig.getDependenciesClassesJarsPostInstrumentation(AndroidArtifacts.ArtifactScope.ALL))
        .disallowChanges()
