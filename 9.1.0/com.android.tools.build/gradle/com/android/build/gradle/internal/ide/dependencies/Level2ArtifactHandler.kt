...
class Level2ArtifactHandler(localJarCache: CreatingCache<File, List<File>>, mavenCoordinatesCache: MavenCoordinatesCacheBuildService) :
  ...
  override fun handleAndroidLibrary(
    ...
    return AndroidLibraryImpl(addressSupplier(), aarFile, folder, null, /* resStaticLibrary */ localJarsAsString)
  }
  ...
  override fun handleAndroidModule(
    ...
    coordinatesSupplier: () -> MavenCoordinates,
    addressSupplier: () -> String,
  ): Library = ModuleLibraryImpl(addressSupplier(), buildId, projectPath, variantName)
