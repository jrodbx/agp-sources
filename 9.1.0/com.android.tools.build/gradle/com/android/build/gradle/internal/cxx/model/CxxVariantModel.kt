...
data class CxxVariantModel(
  ...
  /** C flags forwarded to compiler ex, android.defaultConfig.externalNativeBuild.cFlags '-DTHIS_IS_C=1' */
  val cFlagsList: List<String>,

  /** C++ flags forwarded to compiler ex, android.defaultConfig.externalNativeBuild.cppFlags '-DTHIS_IS_CPP=1' */
  ...
  /** The list of build targets. ex, android.defaultConfig.externalNativeBuild.targets "my-target" */
  val buildTargetSet: Set<String>,

  /**
   * The list of implicit build targets determined by other parts of the build.
   *
   * Currently the only use of this is for forcing static libraries to build if they are named in an android.prefab block.
   */
  val implicitBuildTargetSet: Set<String>,

  /** The CMakeSettings.json configuration ex, android .defaultConfig .cmake .externalNativeBuild .configuration 'my-configuration' */
  ...
  /** A word like Debug, Release, or MinSizeRel. It represents the optimization level common to all ABIs in a variant. */
...
/** A predictable location to republish files like compile_commands.json. ex, $moduleRootFolder/.cxx/tools/debug */
