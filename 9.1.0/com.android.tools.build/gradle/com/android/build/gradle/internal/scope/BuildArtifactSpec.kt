...
data class BuildArtifactSpec(val type: Artifact<*>, val appendable: Boolean, val replaceable: Boolean) {
  companion object {
    private val specMap =
      mapOf(
    ...
    fun spec(type: Artifact<*>, appendable: Boolean, replaceable: Boolean) = type to BuildArtifactSpec(type, appendable, replaceable)

    fun get(type: Artifact<*>) = specMap[type] ?: throw RuntimeException("Specification is not defined for type '$type'.")
