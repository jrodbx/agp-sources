...
open class BuildFeatureValuesImpl
constructor(
  ...
  override val compose: Boolean = projectServices.plugins.hasPlugin(COMPOSE_COMPILER_PLUGIN_ID) || (buildFeatures.compose ?: false)
  ...
  private val _resValues: Boolean = buildFeatures.resValues ?: projectOptions[BooleanOption.BUILD_FEATURE_RESVALUES]
  ...
  override val prefabPublishing: Boolean =
    when (buildFeatures) {
  ...
  override val mlModelBinding: Boolean =
