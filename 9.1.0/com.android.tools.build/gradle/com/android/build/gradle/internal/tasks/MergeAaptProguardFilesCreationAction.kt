...
/** Configuration action for a task to merge aapt proguard files. See [MergeFileTask] for Task implementation. */
class MergeAaptProguardFilesCreationAction(creationConfig: ConsumableCreationConfig) :
  VariantTaskCreationAction<MergeFileTask, ConsumableCreationConfig>(creationConfig) {
