...
/** Transform a [SynchronizeFile] into an [EncodedSynchronizeFile] by encoding strings with [StringEncoder]. */
...
/** Transform a [EncodedSynchronizeFile] into an [SynchronizeFile] by decoding strings with [StringDecoder]. */
...
fun decodeSynchronizeFile(encoded: EncodedSynchronizeFile, decoder: StringDecoder) = encoded.decode(decoder)

/** Transform a [FileFingerPrint] into an [EncodedFileFingerPrint] by encoding strings with [StringEncoder]. */
...
/** Transform a [EncodedFileFingerPrint] into an [FileFingerPrint] by decoding strings with [StringDecoder]. */
...
fun decodeFileFingerPrint(encoded: EncodedFileFingerPrint, decoder: StringDecoder) = encoded.decode(decoder)
