 ...
 * @param isClassifierRequired Whether the artifact of this configuration needs classifier for maven publishing.
 *
 * Note if [configType] is not a publicationConfig, [componentName] and [isClassifierRequired] don't apply and are set to default values.
 */
data class PublishedConfigSpec
@JvmOverloads
constructor(
  ...
  constructor(
    configType: AndroidArtifacts.PublishedConfigType,
    component: ComponentPublishingInfo,
