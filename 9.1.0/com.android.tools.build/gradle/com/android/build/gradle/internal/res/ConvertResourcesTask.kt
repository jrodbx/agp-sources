...
/** Converts resources from binary format to proto format or vice versa (see https://developer.android.com/tools/aapt2#convert). */
@CacheableTask
...
sealed class ConvertResourcesTask<TaskT : ConvertResourcesTask<TaskT>> : NonIncrementalTask() {
  ...
  @get:InputDirectory @get:PathSensitive(PathSensitivity.RELATIVE) abstract val resourcesInputDir: DirectoryProperty

  @get:OutputDirectory abstract val resourcesOutputDir: DirectoryProperty

  @get:Internal abstract val convertToProto: Boolean

  @get:Internal abstract val outputArtifactType: InternalArtifactType<Directory>

  @get:Internal abstract val artifactTransformationRequest: Property<ArtifactTransformationRequest<TaskT>>

  @get:Nested abstract val multiOutputHandler: Property<MultiOutputHandler>

  @get:Nested abstract val aapt2Input: Aapt2Input
...
abstract class ConvertResourcesAction @Inject constructor() : WorkActionAdapter<ConvertResourcesParams> {

  override fun doExecute() {
    parameters.aapt2Input
      .get()
      .getLeasingAapt2()
      .convert(
        AaptConvertConfig(
