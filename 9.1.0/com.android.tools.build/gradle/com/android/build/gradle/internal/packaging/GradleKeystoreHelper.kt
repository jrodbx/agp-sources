...
fun AndroidLocationsProvider.getDefaultDebugKeystoreLocation(): File =
  try {
...
fun createDefaultDebugStore(defaultDebugKeystoreLocation: File, logger: Logger) {
  ...
  logger.info("Creating default debug keystore at {}", defaultDebugKeystoreLocation.absolutePath)
  try {
    if (
