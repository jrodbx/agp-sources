...
abstract class SigningConfig @Inject constructor(name: String, dslServices: DslServices) :
  DefaultSigningConfig(name), Serializable, Named, com.android.build.api.dsl.ApkSigningConfig, InternalSigningConfig {
