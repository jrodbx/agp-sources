 ...
 * components that runs instrumented tests.
 */
interface InstrumentedTestComponentDslInfo {
  ...
  /**
   * Returns the instrumentationRunner arguments to use to test this variant, or if the variant is a test, the ones to use to test the
   * tested variant
   */
