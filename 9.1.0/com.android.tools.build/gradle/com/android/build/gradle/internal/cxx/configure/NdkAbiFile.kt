...
fun parseAbiJson(reader: Reader, abiFile: String): List<AbiInfo> {
  return Gson().fromJson<Map<String, NullableAbiInfo>>(reader, mapTypeToken).entries.mapNotNull { entry ->
    val raw = entry.value
...
private val Abi.llvmTriple: String
  get() =
    when (this) {
