 ...
 *
 * Caching disabled by default for this task because the task does very little work. Input values are written to a minimal JSON file and no
...
abstract class SigningConfigVersionsWriterTask : NonIncrementalTask() {
  ...
  @get:Input abstract val enableV1Signing: Property<Boolean>

  @get:Input abstract val enableV2Signing: Property<Boolean>

  @get:Input abstract val enableV3Signing: Property<Boolean>

  @get:Input abstract val enableV4Signing: Property<Boolean>

  @get:Input @get:Optional abstract val overrideEnableV1Signing: Property<Boolean>

  @get:Input @get:Optional abstract val overrideEnableV2Signing: Property<Boolean>
  ...
  class CreationAction(creationConfig: ApkCreationConfig) :
    VariantTaskCreationAction<SigningConfigVersionsWriterTask, ApkCreationConfig>(creationConfig) {
    ...
    override fun handleProvider(taskProvider: TaskProvider<SigningConfigVersionsWriterTask>) {
      super.handleProvider(taskProvider)
      creationConfig.artifacts
        .setInitialProvider(taskProvider, SigningConfigVersionsWriterTask::outputFile)
        .withName("signing-config-versions.json")
        .on(InternalArtifactType.SIGNING_CONFIG_VERSIONS)
    }

    override fun configure(task: SigningConfigVersionsWriterTask) {
      ...
      task.overrideEnableV1Signing.setDisallowChanges(creationConfig.services.projectOptions.get(OptionalBooleanOption.SIGNING_V1_ENABLED))
      task.overrideEnableV2Signing.setDisallowChanges(creationConfig.services.projectOptions.get(OptionalBooleanOption.SIGNING_V2_ENABLED))
    }
  }
}
