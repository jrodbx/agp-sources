...
/**
 * Given a CMake server [Target], extract the runtime files for it. Return null if there are no [linkLibraries] or if this is an object
 * library.
 */
        ...
        .let {
          if (!it.isAbsolute) {
            if (buildDirectory == null) {
              warnln(CMAKE_SERVER_BUILD_DIRECTORY_MISSING, "Could not resolve path to '$it' because CMake did not define build directory")
              null
