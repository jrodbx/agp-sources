 ...
 *
 * The filters guarantees that [executeFor] only runs the actions on [ComponentT] that match the them.
 *
 * The filters can be based on the type of [ComponentT] and on the properties of [ComponentIdentity].
 */
