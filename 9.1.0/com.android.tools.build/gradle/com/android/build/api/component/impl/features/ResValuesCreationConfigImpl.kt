...
class ResValuesCreationConfigImpl(private val dslInfo: AndroidResourcesDslInfo, private val internalServices: VariantServices) :
  ResValuesCreationConfig {
  override val resValues: MapProperty<ResValue.Key, ResValue> by lazy {
    internalServices.mapPropertyOf(ResValue.Key::class.java, ResValue::class.java, dslInfo.getResValues())
  }
}
