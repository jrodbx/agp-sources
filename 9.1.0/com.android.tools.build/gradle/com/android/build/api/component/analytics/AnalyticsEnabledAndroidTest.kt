...
open class AnalyticsEnabledAndroidTest
@Inject
constructor(override val delegate: AndroidTest, stats: GradleBuildVariant.Builder, objectFactory: ObjectFactory) :
  AnalyticsEnabledDeviceTest(delegate, stats, objectFactory), AndroidTest {
