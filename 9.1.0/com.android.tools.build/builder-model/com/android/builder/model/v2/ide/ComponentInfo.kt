...
interface ComponentInfo {
   ...
   *
   * Build types and product flavor attributes are handled explicitly in [buildType] and [productFlavors], so they are not included here
   */
  ...
  /** Indicates whether this component (library or module) is a test fixtures component (i.e. has a test fixtures capability). */
