...
interface Versions : AndroidModel {
  interface Version {
     ...
     *
     * For example, minimum model consumer version 64.1 might correspond to Android Studio Giraffe patch 1.
     */
  ...
  companion object {
    ...
    /**
     * The minimum required model consumer version, to allow AGP to drop support for older versions of Android Studio.
     *
     ...
     *
     * The minor version is increased every time an addition is made to the model interfaces, or other semantic change that the code
     * injected by studio should react to.
     *
     * The major version is increased, and the minor version reset to 0 every time AGP is branched to allow for changes in that branch to be
     * modelled.
     *
