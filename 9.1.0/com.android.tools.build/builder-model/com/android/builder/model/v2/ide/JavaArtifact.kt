 ...
 *
 * This artifact is for Java components inside an Android project, which is only unit tests for now.
 *
 * @since 4.2
 */
interface JavaArtifact : AbstractArtifact, AndroidModel {
  ...
  /**
   * Returns the folder containing resource files that classes from this artifact expect to find on the classpath.
   *
