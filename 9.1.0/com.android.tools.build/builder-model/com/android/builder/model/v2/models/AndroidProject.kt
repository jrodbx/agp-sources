...
interface AndroidProject : AndroidModel {
   ...
   *
   * This is here rather than on [com.android.builder.model.v2.ide.AndroidArtifact] because this is common to all artifacts as it cannot be
   * changed per variants.
   */
  ...
  /**
   * Returns desugar.json configuration files for library desugaring, or empty when library desugaring is not enabled. Currently, there
   * would only be one desugar.json file for the entire project, but could be more in the future if r8 team decides to publish more.
   */
