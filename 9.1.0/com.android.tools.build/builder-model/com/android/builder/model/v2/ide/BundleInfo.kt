...
interface BundleInfo : AndroidModel {
  ...
  /**
   * The path to the listing file generated after each [bundleTaskName] task execution. The listing file will contain a reference to the
   * produced bundle file (.aab).
   */
  ...
  /**
   * The path to the model file generated after each [apkFromBundleTaskName] task execution. The model will contain a reference to the
   * folder where APKs from bundle are placed into.
   */
