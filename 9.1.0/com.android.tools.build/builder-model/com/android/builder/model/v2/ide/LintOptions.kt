...
interface LintOptions : AndroidModel {
  ...
  /**
   * The exact set of issues to check. If empty lint will detect the issues that are enabled by default plus any issues enabled via [enable]
   * and without issues disabled via [disable].
   */
  ...
  /** The target sdk version used when generating a lint report for a library. This should only be set for libraries. */
