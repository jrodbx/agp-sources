...
interface BaseConfig : AndroidModel {
  ...
  /** Map of Build Config Fields where the key is the field name. If null, buildConfig is disabled in the project. */
  val buildConfigFields: Map<String, ClassField>?

  /** Map of generated res values where the key is the res name. If null, res values are disabled in the project. */
