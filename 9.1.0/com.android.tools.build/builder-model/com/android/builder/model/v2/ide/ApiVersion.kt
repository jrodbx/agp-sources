 ...
 *
 * Release versions of the Android platform are identified by their API level (integer), (technically the code name for release version is
 * "REL" but this class will return `null` instead.)
 *
