...
/**
 * Basic Entry point for the model of the Android Projects. This models a single module, whether the module is an app project, a library
 * project, an Instant App feature project, an instantApp bundle project, or a dynamic feature split project.
 *
 * This part only contains the most basic information: the source folders. For more information see [AndroidProject]
 */
interface BasicAndroidProject : AndroidModel {
   ...
   *
   * This only contains the most basic information about the variant: their buildtype/flavors and their source sets.
   */
  val variants: Collection<BasicVariant>

  /** The boot classpath matching the compile target. This is typically android.jar plus other optional libraries. */
