...
internal class KmpDeviceTestOptionsDslInfoImpl(
    ...
    private val testOnDeviceConfig
        get() = extension.androidTestOnDeviceOptions ?: throw RuntimeException(
            "Android tests on device are not enabled. (use `kotlin.${KotlinMultiplatformAndroidPlugin.DEPRECATED_ANDROID_EXTENSION_ON_KOTLIN_EXTENSION_NAME}.withDeviceTest {}` to enable)"
        )
